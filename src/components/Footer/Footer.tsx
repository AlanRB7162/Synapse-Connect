    ...
    return(
        <Flex as="footer" px={8} py={4} direction='column' gap={4} pt='25px'>
            <Flex className='conteudo' direction={{base:'column', md:'row'}}>
                <Flex className='descricao' width={{base:'100%', md:'50%'}} justify='center' direction='column' mr='20px'>
                    <LogoTitle/>
                ...
                <Flex className='links' width={{base:'100%', md:'25%'}} justify='center' direction='column' ml='20px'>
                    ...
                    <Flex><Link variant='underline' href='/about' className='link'><Icon as={FaCircleInfo as ElementType} className='icon'/>Sobre</Link></Flex>
