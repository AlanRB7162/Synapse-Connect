        ...
        <Popover.Content>
          ...
          <Popover.Body className="popover-body">
            <Flex direction="column" align="center" justify="center" width="100%" padding="4" gap="2">
                ...
                <Button id="btSair" className="user-avatar-button btSair" variant='outline' width='100%'><Icon as={FaRightFromBracket as ElementType} className='icon fa-right-from-bracket'/>Sair</Button>
            </Flex>
          </Popover.Body>
        </Popover.Content>
      </Popover.Positioner>
